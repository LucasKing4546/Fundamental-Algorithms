...
def test_sort_patients_by_pnc():
    ...
    controller.sort_patients_by_pnc(3)

    assert repo.get_department(1).get_list_of_patients().get_all_patients()[0].get_first_name() == "Alice"
    assert repo.get_department(2).get_list_of_patients().get_all_patients()[0].get_first_name() == "Zane"
    assert repo.get_department(3).get_list_of_patients().get_all_patients()[0].get_first_name() == "Ethan"
...
def test_sort_by_number_of_patient_over_an_age():
    ...
    assert len(departments[0].get_list_of_patients().get_all_patients()) == 0
    assert len(departments[1].get_list_of_patients().get_all_patients()) == 1
    assert len(departments[2].get_list_of_patients().get_all_patients()) == 2
...
def test_get_departments_patients_under_an_age():
    ...
    assert departments[1].get_name() == "Pediatrics"
    assert len(departments[1].get_list_of_patients().get_all_patients()) == 2
...
def test_get_departments_patient_first_name():
    ...
    assert departments[0].get_list_of_patients().get_all_patients()[1].get_first_name() == "Grace"
...
def test_get_patients_first_or_last_name():
    ...
    controller = HospitalController(repo)
    patients = controller.get_patients_first_or_last_name(2, "ane")
